...
document.getElementById("txt1").innerHTML = "➡✅Como Hacer un Cautin Casero con Transformador‼️😮✅<br>"+
												"Escribe gracias si te gusta el video👇<br>"+
...
document.getElementById("txt2").innerHTML = "✅💥Como amplificar la señal de tu celular con simple truco‼️ 😮<br>"+
												"Escribe OK para saber que estas activo👇<br>"+
...
document.getElementById('txt3').innerHTML =	"💥Haz tu propio cautin casero, te puede salvar de un apuro‼️😮💥 <br>"+
												"Di GRACIAS si te ha gustado el video⬇️ <br>"+
												"https://youtu.be/KAjPSyUslL0"; 
  
document.getElementById("img4").src= "imgv/4.png"; 
document.getElementById('txt4').innerHTML =	"✅💥Como evitar que las lamparas parpadeen💡😮<br>"+
												"escribe Ok para mas videos💥👇 <br>"+
												"https://youtu.be/WWXZUvsZ21M";  
  
  
document.getElementById("img5").src= "imgv/5.png"; 
document.getElementById('txt5').innerHTML =	"🔌💥Como hacer un Cargador de Batería con transformador, ✅<br>"+
												"di OK para saber que estas activo‼️💥<br>"+
												"https://youtu.be/RuRDiat6jTw"; 

document.getElementById("img6").src= "imgv/6.png";
document.getElementById('txt6').innerHTML = "✅Como lograr que un foco LED dure 50 años! 💥😮<br />"+
											"Comparte este video para ver mas videos como este‼️<br />"+
...
document.getElementById('txt7').innerHTML = "✅💥10 cosas que puedes hacer con teléfonos celulares viejos‼️ 😮<br />"+
											"Di GRACIAS si te ha gustado el video💥<br />"+
...
document.getElementById('txt10').innerHTML = "✅💥Como Hacer un Control de Temperatura para Cautin, 😮<br />"+
											"Escribe OK para saber que estas activo‼️💥<br />"+
											"https://youtu.be/q_h6VSfrrTQ";
  
document.getElementById("img11").src= "imgv/11.png";
document.getElementById('txt11').innerHTML =  "✅💥Como hacer un cargador universal de batería de celular, 😮<br />"+
											"Comparte si quieres mas videos como este‼️💥<br />"+
											"https://youtu.be/C0is4jnWRpQ";
  
document.getElementById("img12").src= "imgv/12.png";
document.getElementById('txt12').innerHTML = "✅💥Como hacer el motor mas simple del mundo, 😮<br />"+
											"Escribe ok para saber que estas activo‼️💥<br />"+
											"https://youtu.be/eLvZOFccYA0"; 
  
document.getElementById("img13").src= "imgv/13.png";
document.getElementById('txt13').innerHTML = "🔥✅Como encender un foco desde tres lugares diferentes💡👷<br />"+
											"di GRACIAS si quieres mas videos‼️⚡<br />"+
											"https://youtu.be/b5vugs1xYiQ";
  
document.getElementById("img14").src= "imgv/14.png";
document.getElementById('txt14').innerHTML =  "🔥⚠️7 errores en instalaciones eléctricas caseras que debes evitar😮<br />"+
											"Di Gracias y aqui les dejo el video‼️💥<br />"+
											"https://youtu.be/Lr09BWA6ZaA"; 
  
document.getElementById("img15").src= "imgv/15.png";
document.getElementById('txt15').innerHTML =	"💥✅Como hacer un amplificador wifi para conectar con redes distantes💥😮<br/>"+
											"Escribe OK para saber que me leiste‼️<br />"+
...
document.getElementById('txt16').innerHTML = "💥✅Como hacer una antena wifi super potente, ‼️💥😮<br />"+
											"Escribe GRACIAS para seguir publicando<br />"+
...
document.getElementById('txt17').innerHTML = "💥5 cosas que puedes hacer con un simple foco💡🏠<br />"+  
											"Di OK si te gustan los inventos!💥😁<br />"+
...
document.getElementById('txt18').innerHTML = "💥✅Como convertir un foco LED de 120v a 12v con simple truco‼️💥😮<br />"+
											"DI GRACIAS y mira el video aqui⬇️<br />"+
...
document.getElementById('txt27').innerHTML ="✅💥Como hacer una antena wifi de largo alcance fácil en 5 min‼️👍💥💯 <br />"+
										"DI GRACIAS si te gustan los inventos⬇️👇👇<br />"+
										"https://youtu.be/RAQ6czAUuK8";
											
document.getElementById("img28").src= "imgv/28.png";
document.getElementById('txt28').innerHTML ="✅💥Tutorial básico sobre resistencias y capacitores 😁💥💯 <br />"+
										"Di Gracias y aqui les dejo el video‼️⬇️<br />"+
										"https://youtu.be/vJnGSqnFgvw";	
											
document.getElementById("img29").src= "imgv/29.png" ;
document.getElementById('txt29').innerHTML ="✅💥Tutorial de electrónica Inductores y diodos 😁💥💯 <br />"+
										"Di Gracias y aqui les dejo el video‼️👇<br />"+
										"https://youtu.be/vJnGSqnFgvw";	
...
document.getElementById('txt33').innerHTML = 	"😮✅Mira que pasa si conecto una memoria usb a un cargador de celular‼️💥💯😁<br />"+
												"Di GRACIAS si te gustan los inventos caseros‼️⬇️<br />"+
...
document.getElementById('txt42').innerHTML = 	"✅👉Como reconocer los cables de cualquier transformador con simple truco‼️😊💯 <br />"+
												"Di GRACIAS y aqui les dejo el video completo‼️👇⬇️ <br />"+
...
document.getElementById('txt50').innerHTML = 	"💥Que pasa si conectas positivo con negativo por error‼️👀✅😮 <br />"+
												"Di OK si te gustan los invetos caseros‼️👇 <br />"+
...
document.getElementById('txt54').innerHTML =	"✅💥Tutorial Electrónica básica TRANSISTORES 😊💯💥 <br />"+
												"Di Gracias y aqui les dejo el video‼️ <br />"+
												"https://youtu.be/lN0AfX0XI8s";									
											
											
document.getElementById("img55").src= "imgv/55.png";
document.getElementById('txt55').innerHTML = 	"✅💥Tutorial electrónica básica REGULADORES 😊💯💥 <br />"+
												"Di Gracias y aqui les dejo el video‼️⬇️ <br />"+
...
document.getElementById('txt61').innerHTML = 	"💥Como recargar cualquier Celular con simple truco‼️😊💯💥 <br />"+
												"Di Gracias y aqui les dejo el video‼️ <br />"+
...
document.getElementById("img64").src= "imgv/65.png";
document.getElementById('txt64').innerHTML = 	"✅💥Como cargar una bateria con simple truco! Genial Invento!‼️🔌😮💥✅<br />"+
												"Di GRACIAS y aqui les dejo esta genial idea👇<br />"+
